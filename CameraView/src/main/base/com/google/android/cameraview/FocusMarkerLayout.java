    ...
    public void focus(float mx, float my) {
        ...
        mFocusMarkerContainer.animate().scaleX(1).scaleY(1).setStartDelay(0).setDuration(330)
                .setListener(new AnimatorListenerAdapter() {
                    ...
                    public void onAnimationEnd(Animator animation) {
                        ...
                        mFocusMarkerContainer.animate().alpha(0).setStartDelay(50).setDuration(100).setListener(null).start();
                    }
                }).start();
        ...
        mFill.animate().scaleX(1).scaleY(1).setDuration(330)
                .setListener(new AnimatorListenerAdapter() {
                    ...
                    public void onAnimationEnd(Animator animation) {
                        super.onAnimationEnd(animation);
                        mFill.animate().alpha(0).setDuration(100).setListener(null).start();
                    }
                }).start();
